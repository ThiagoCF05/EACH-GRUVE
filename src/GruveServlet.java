...
public class GruveServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException{ 
		...
		//String currentDir = "workspace" + fsep + "gruve" + fsep + "WebContent" + fsep + "WEB-INF" + fsep;
		
		String currentDir = "/home/thiago/workspace/gruve/WebContent/WEB-INF/";
		...
		if (!allIMs.containsKey(currentSessionId) && !currentSessionId.equals("null")){
			...
			String iLogsDir = "/home/thiago/workspace/gruve/WebContent" + fsep + "ilogs" + fsep;
